...
#define MyAppVersion "0.17.0-rc3"
...
OutputBaseFilename=HADocs_Setup_v{#MyAppVersion}
Compression=lzma
...
[Files]
Source: "..\dist\HADocs\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
