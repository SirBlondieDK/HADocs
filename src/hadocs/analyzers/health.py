def calculate_health_score(analysis: dict) -> tuple[int, list[str]]:
    ...
    This score tries to reflect real-world smart home health instead of raw Home
    Assistant entity states. Service-only entities, buttons, updates, events, and
    similar system entities should already be filtered out by the analyzer.
    """
    score = 100
    notes = []
