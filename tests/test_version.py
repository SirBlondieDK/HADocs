...
def test_product_versions():
    assert WINDOWS.display_version == "0.17.0-rc2"
    assert CORE.display_version == "0.17.0-rc2"
    assert DOCKER.display_version == "0.17.0-rc2"
    assert HOME_ASSISTANT_ADDON.display_version == "0.17.0-rc2"
