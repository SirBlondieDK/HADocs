...
def main():
    ...
    print("Model-object HTML wrapper fix applied.")
    print("")
    print("Run:")
    ...
    print("")
    print("Commit:")
    print("  git add -f src/hadocs/reports/html_hook.py docs/V101_MODEL_OBJECT_WRAPPER_FIX.md tools/apply_v101_model_object_wrapper_fix.py")
    print('  git commit -m "Fix HTML dashboard model compatibility"')
    print("  git push")
