...
HADocs is a local-first **Home Assistant Analysis Platform**. Start with the [project README](../README.md) for the product overview.
...
- [Analysis and Dashboard Engine](guides/features/Analysis.md)
- [Root Cause Analysis](guides/features/Root-Causes.md)
- [Health Score and Potential Health Score](guides/features/Health-Score.md)
- [Explorer](guides/features/Explorer.md)
- [Knowledge Pack](guides/features/Knowledge-Pack.md)
...
- [GitHub workflow](guides/development/GITHUB_SETUP.md)
...
- [Vision](architecture/00-Vision.md)
